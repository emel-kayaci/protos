...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminRequest, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsAdminRequest)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequest) (*IsAdminRequest, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequest) (*IsAdminRequest, error) {
