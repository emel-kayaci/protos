...
const file_proto_sso_sso_proto_rawDesc = "" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xaa\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x125\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x14.auth.IsAdminRequestB\x0eZ\fsso.v1;ssov1b\x06proto3"
...
var file_proto_sso_sso_proto_depIdxs = []int32{
	...
	4, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminRequest
